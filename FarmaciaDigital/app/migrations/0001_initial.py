# Generated by Django 4.0.4 on 2023-04-06 07:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identificacion_cesfam', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comuna',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_consulta', models.IntegerField(choices=[[0, 'Consulta'], [1, 'Cotizacion'], [2, 'Sugerencia'], [3, 'Felicitaciones'], [4, 'Reclamo']], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_diabetes', models.IntegerField(choices=[[0, 'No padezco esta enfermedad'], [1, 'Prediabetes'], [2, 'Diabetes tipo 1'], [3, 'Diabetes tipo 2'], [4, 'Diabetes gestacional']], null=True)),
                ('tipo_hipertension', models.IntegerField(choices=[[0, 'No padezco esta enfermedad'], [1, 'Hipertensión grado 1'], [2, 'Hipertensión grado 2'], [3, 'Hipertensión grado 3']], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_comuna', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.comuna')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identificacion_QF', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Provincia',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CEESFAM_asignado', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.cesfam')),
                ('identificacion_profesional', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ficha_clinica_paciente', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.pacientefichaclinica')),
                ('identificacicion_usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('identificacion_profesional', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.profesionalsalud')),
            ],
        ),
        migrations.CreateModel(
            name='PacienteReceta',
            fields=[
                ...
                ('fracionamiento_1', models.IntegerField(choices=[[0, '1 Una pastilla entera'], [1, '1/4 Un quarto de pastilla'], [2, '1/2 Media Pastilla'], [3, '3/4 Tres cuartos de pastilla'], [4, '1/8 Un octavo de pastilla']], null=True)),
                ('horario_2', models.TimeField(blank=True, null=True)),
                ('fracionamiento_2', models.IntegerField(blank=True, choices=[[0, '1 Una pastilla entera'], [1, '1/4 Un quarto de pastilla'], [2, '1/2 Media Pastilla'], [3, '3/4 Tres cuartos de pastilla'], [4, '1/8 Un octavo de pastilla']], null=True)),
                ('horario_3', models.TimeField(blank=True, null=True)),
                ('fracionamiento_3', models.IntegerField(blank=True, choices=[[0, '1 Una pastilla entera'], [1, '1/4 Un quarto de pastilla'], [2, '1/2 Media Pastilla'], [3, '3/4 Tres cuartos de pastilla'], [4, '1/8 Un octavo de pastilla']], null=True)),
                ('horario_4', models.TimeField(blank=True, null=True)),
                ('fracionamiento_4', models.IntegerField(blank=True, choices=[[0, '1 Una pastilla entera'], [1, '1/4 Un quarto de pastilla'], [2, '1/2 Media Pastilla'], [3, '3/4 Tres cuartos de pastilla'], [4, '1/8 Un octavo de pastilla']], null=True)),
                ('horario_5', models.TimeField(blank=True, null=True)),
                ('fracionamiento_5', models.IntegerField(blank=True, choices=[[0, '1 Una pastilla entera'], [1, '1/4 Un quarto de pastilla'], [2, '1/2 Media Pastilla'], [3, '3/4 Tres cuartos de pastilla'], [4, '1/8 Un octavo de pastilla']], null=True)),
                ('horario_6', models.TimeField(blank=True, null=True)),
                ('fracionamiento_6', models.IntegerField(blank=True, choices=[[0, '1 Una pastilla entera'], [1, '1/4 Un quarto de pastilla'], [2, '1/2 Media Pastilla'], [3, '3/4 Tres cuartos de pastilla'], [4, '1/8 Un octavo de pastilla']], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identificacion_familiar', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.usuarioficha')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identificacion_cesfam', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='app.cesfam')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identificacion_familiar_paciente', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.pacientefamiliar')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identificacion_enfermera', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='comuna',
        ...
        migrations.AddField(
            model_name='usuario',
            name='tipo_usuario',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='app.tipo_usuario'),
        ),
        migrations.AddField(
            model_name='usuario',
