...
class ProfesionalPaciente(models.Model):
    ...
    ficha_clinica_paciente = models.ForeignKey(PacienteFichaClinica, on_delete=models.SET_NULL,null=True,related_name="Fpaciente",limit_choices_to=Q(identificacion_paciente="Paciente"))
    def __str__(self):
