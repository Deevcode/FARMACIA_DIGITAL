...
from .views import home, contacto, medicamentos, bodega, reportes, agregar_medicamento, listar_medicamentos, modificar_medicamento, eliminar_medicamento,enfermera
